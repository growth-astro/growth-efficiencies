...
def parse_commandline():
    ...
    parser.add_option("-s", "--skymap", help="GW skymap.", default='../data/S190408an/bayestar.fits.gz,../data/S190412m/bayestar.fits.gz,../data/S190512at/bayestar.fits.gz,../data/S190627e/LALInference.fits.gz,../data/S190828j/bayestar.fits.gz,../data/S190910d/bayestar.fits.gz,../data/S190910h/bayestar.fits.gz')
    parser.add_option("-f","--fields", help="Observed fields.", default='../data/S190408an/ZTF_fields.dat,../data/S190412m/ZTF_fields.dat,../data/S190512at/ZTF_fields.dat,../data/S190627e/ZTF_fields.dat,../data/S190828j/ZTF_fields.dat,../data/S190910d/ZTF_fields.dat,../data/S190910h/ZTF_fields.dat')

    parser.add_option("-o", "--output", help="output file",default="../output/overall_BBH.pdf")
...
#center = SkyCoord('12.0h', 30.5, unit=['hourangle','deg'])
#center2 = SkyCoord('1.0h', -24.0, unit=['hourangle','deg'])

center = SkyCoord('16.0h', 30.5, unit=['hourangle','deg'])
