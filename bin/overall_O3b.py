...
def parse_commandline():
    ...
    parser.add_option("-s", "--skymap", help="GW skymap.", default='../data/S200105ae/LALInference.fits.gz,../data/S200115j/LALInference.fits.gz,../data/S200213t/LALInference.fits.gz')
    parser.add_option("-f","--fields", help="Observed fields.", default='../data/S200105ae/ZTF_fields.dat,../data/S200115j/ZTF_fields.dat,../data/S200213t/ZTF_fields.dat')

    parser.add_option("-o", "--output", help="output file",default="../output/overall_O3b.pdf")

    parser.add_option("-t", "--telescope", help="Telescope.", default ="ZTF")

    parser.add_option("-c", "--center", help="center.", default='20.0h')
...
center = SkyCoord(opts.center, 30.5, unit=['hourangle','deg'])
...
plt.savefig(opts.output,dpi=100,bbox_inches='tight')    
plt.close()    
